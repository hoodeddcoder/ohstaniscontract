      ...
      <>
        ...
        :
          <div className="no-wallet">
            ...
            Welcome to <strong>THEOHTANIS</strong><span className="emoji"></span><br />
            <br></br> 
              
            Theohtanis is a culmination of two cultures traditions centuries in the making starting with the Japanese Samurai two sword fighting styles as far back 12th century.<a ></a><span className="emoji"></span><br />
            <br></br>
            ...
            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                ...
                <p>
                  Are you on our Whitelist? <strong>Verify</strong> if you are by pasting your wallet address below!
                </p>
